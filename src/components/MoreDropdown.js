...
const ThreeDots = React.forwardRef(({ onClick }, ref) => (
  <i className="fas fa-ellipsis-v" ref={ref}  onClick={(e) => {
      e.preventDefault();
      onClick(e);
    }}
  />
));
//drop down menue for handle delete/ edit functions
...
// drop down menu to handle edit profile / username and password
